...
{
    Task<PagedResponse<ToolResponse>> GetAllAsync(string? search, string? categoryName, string? status, int? page, int? pageSize, CancellationToken cancellationToken = default);
